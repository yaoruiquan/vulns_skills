...
3. 脚本会解析标题、漏洞概述表、修复方案、参考资料、产品能力覆盖，并填充 `assets/wechat-alert-article-template.placeholders.html`。
...
- 不要在正文开头插入源 Markdown 的 logo、封面图或独立大标题；正文直接从“漏洞概述”表格开始，封面只作为公众号草稿封面使用。
